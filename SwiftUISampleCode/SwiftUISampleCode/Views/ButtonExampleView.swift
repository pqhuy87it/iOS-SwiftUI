...
struct ButtonExampleView: View {
    ...
    @State var message = "Nhấn giữ để xoá"
    ...
    var body: some View {
        List {
            ...
            // ┌──────────────────────┬──────────┬──────────────────────────────┐
            // │ buttonBorderShape    │ Min iOS  │ Mô tả                        │
            // ├──────────────────────┼──────────┼──────────────────────────────┤
            // │ .automatic           │ 15       │ Mặc định tuỳ theo ngữ cảnh   │
            // │ .capsule             │ 15       │ Hình con nhộng (bo tròn 2 đầu│
            // │ .circle              │ 15       │ Hình tròn hoàn hảo           │
            // │ .roundedRectangle    │ 15       │ Chữ nhật bo góc (tuỳ chỉnh R)│
            // └──────────────────────┴──────────┴──────────────────────────────┘
            VStack(spacing: 16) {
            ...
            ButtonGroup(primaryTitle: "Confirm", secondaryTitle: "Delete Account") {
                print("first action")
            } secondaryAction: {
                print("second action")
            }
            ...
            DestructiveButton(title: "Confirm", message: "Do something") {
                print("do something")
            }
